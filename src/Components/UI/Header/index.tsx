        ...
        return (
            <WrappingComponent>
                ...
                <ul id="slide-out" className="sidenav">
                    ...
                    {
                        Pages.map((page) => {
                            const link = (page.link && page.link.length > 0) ? <Link className="sidenav-close" to={page.link}>{page.name}</Link> : <a href="javascript:void(0);" className="sidenav-close">{page.name}</a>;
                            return (
                                <li key={page.name}>{link}</li>
                            );
                        })
